...
function drawCanvas(context, r, checks) {
    ...
    //hinh chu nhat
    context.fillRect(width / 3.3, height / 10, width / 5, height / 5 * 2);
    // x = w/5*2.5
    context.beginPath();
    //ban nguyet va tam giac
    context.moveTo(width / 2, height / 2);
    context.lineTo(width / 5 * 4.5, height / 5 * 2.5);
    context.lineTo(width / 2, height / 5 * 4.5);
    context.fill();
    context.moveTo(width /2, height / 2);
    context.arc(width / 2, width / 2, width / 5, Math.PI *0.5, Math.PI );
    context.fill();
    context.beginPath();
